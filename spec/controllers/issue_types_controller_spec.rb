...
RSpec.describe IssueTypesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested issue_type as @issue_type" do
      issue_type = IssueType.create! valid_attributes
      get :show, params: {id: issue_type.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested issue_type as @issue_type" do
      issue_type = IssueType.create! valid_attributes
      get :edit, params: {id: issue_type.to_param}, session: valid_session
      expect(assigns(:issue_type)).to eq(issue_type)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new IssueType" do
        expect {
          post :create, params: {issue_type: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved issue_type as @issue_type" do
        post :create, params: {issue_type: invalid_attributes}, session: valid_session
        expect(assigns(:issue_type)).to be_a_new(IssueType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested issue_type" do
        issue_type = IssueType.create! valid_attributes
        put :update, params: {id: issue_type.to_param, issue_type: new_attributes}, session: valid_session
        issue_type.reload
      ...
      it "assigns the requested issue_type as @issue_type" do
        issue_type = IssueType.create! valid_attributes
        put :update, params: {id: issue_type.to_param, issue_type: valid_attributes}, session: valid_session
        expect(assigns(:issue_type)).to eq(issue_type)
      end
    ...
    context "with invalid params" do
      it "assigns the issue_type as @issue_type" do
        issue_type = IssueType.create! valid_attributes
        put :update, params: {id: issue_type.to_param, issue_type: invalid_attributes}, session: valid_session
        expect(assigns(:issue_type)).to eq(issue_type)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested issue_type" do
      issue_type = IssueType.create! valid_attributes
      expect {
        delete :destroy, params: {id: issue_type.to_param}, session: valid_session
      }.to change(IssueType, :count).by(-1)
    end
